...
function ProjectCard({ title, type, status, client, clientIcon, description }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow duration-300">
      {/* Image placeholder */}
      <div className="h-40 bg-gradient-to-br from-pub-green-100 to-pub-green-200 flex items-center justify-center relative">
        <LucideIcons.BarChart3 className="w-12 h-12 text-pub-green-400" />
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {filters.map((filter) => (
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-200 ${
                    activeFilter === filter
                      ? 'bg-pub-green-600 text-white shadow-md'
                      : 'bg-white text-gray-600 border border-gray-200 hover:border-pub-green-300 hover:text-pub-green-600'
                  }`}
                >
                  {filter}
                </button>
                ...
                <div className="flex flex-wrap gap-4">
                  {earlyStageProjectsData.map((project, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-center gap-3 px-5 py-3 bg-white rounded-full border border-gray-200 hover:border-pub-green-300 hover:shadow-md transition-all duration-200"
                      >
                        <Icon className="w-5 h-5 text-pub-green-600" />
          ...
          {/* CTA Section */}
          <ScrollAnimateWrapper>
            <div className="bg-gradient-to-br from-pub-green-600 to-pub-green-700 rounded-2xl p-8 md:p-12 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-3 bg-white text-pub-green-700 font-semibold rounded-lg hover:bg-pub-green-50 transition-colors"
              >
